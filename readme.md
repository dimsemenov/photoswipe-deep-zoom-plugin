...
The plugin requires a single JS file `photoswipe-deep-zoom-plugin.esm.js`, grab it from the [dist/](dist/), an example is there too. To view source code visit [src/](directory).
